...
let normalSudoku: [[String: Int]] = [
  c(0, 0, 0), c(0, 1, 0), c(0, 2, 0), c(0, 3, 1), c(0, 4, 1), c(0, 5, 1), c(0, 6, 2), c(0, 7, 2),
  c(0, 8, 2),
  c(1, 0, 0), c(1, 1, 0), c(1, 2, 0), c(1, 3, 1), c(1, 4, 1), c(1, 5, 1), c(1, 6, 2), c(1, 7, 2),
  c(1, 8, 2),
  c(2, 0, 0), c(2, 1, 0), c(2, 2, 0), c(2, 3, 1), c(2, 4, 1), c(2, 5, 1), c(2, 6, 2), c(2, 7, 2),
  c(2, 8, 2),
  c(3, 0, 3), c(3, 1, 3), c(3, 2, 3), c(3, 3, 4), c(3, 4, 4), c(3, 5, 4), c(3, 6, 5), c(3, 7, 5),
  c(3, 8, 5),
  c(4, 0, 3), c(4, 1, 3), c(4, 2, 3), c(4, 3, 4), c(4, 4, 4), c(4, 5, 4), c(4, 6, 5), c(4, 7, 5),
  c(4, 8, 5),
  c(5, 0, 3), c(5, 1, 3), c(5, 2, 3), c(5, 3, 4), c(5, 4, 4), c(5, 5, 4), c(5, 6, 5), c(5, 7, 5),
  c(5, 8, 5),
  c(6, 0, 6), c(6, 1, 6), c(6, 2, 6), c(6, 3, 7), c(6, 4, 7), c(6, 5, 7), c(6, 6, 8), c(6, 7, 8),
  c(6, 8, 8),
  c(7, 0, 6), c(7, 1, 6), c(7, 2, 6), c(7, 3, 7), c(7, 4, 7), c(7, 5, 7), c(7, 6, 8), c(7, 7, 8),
  c(7, 8, 8),
  c(8, 0, 6), c(8, 1, 6), c(8, 2, 6), c(8, 3, 7), c(8, 4, 7), c(8, 5, 7), c(8, 6, 8), c(8, 7, 8),
  c(8, 8, 8),
]
